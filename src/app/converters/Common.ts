...
export const basho = new Codes(
  [
    ...
    { code: 82, kol: "82", jrdb: /77|土|トルコ/, naiyou: "トルコ", tanshuku: "土国" },
    { code: 83, kol: "83", jrdb: /華|カター/, naiyou: "カタール", tanshuku: "華国" },
    ...
    { code: 76, kol: "76", jrdb: /74|典|瑞|スウェ/, naiyou: "スウェーデン", tanshuku: "典国" },
